...
<body>
	...
	<div>
		...
		<form autocomplete="off"
			action="<%=request.getContextPath()%>/customer/update" method="post">

			<input type="hidden" name="cust_id"
				value="<%=customerDetails.getId()%>"> <b>Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the name" placeholder="EX: Jhon"
				onfocusout="this.placeholder='EX: Jhon'"
				onfocus="this.placeholder=''" type="text" name="nume"
				value="<%=customerDetails.getName()%>" required="required"
				oninvalid="this.setCustomValidity('Please enter valid name')"
				oninput="setCustomValidity('')"></input><br> <b>Sex:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
			...
			<input type="radio" name="sex" value="M"> Male <input
				type="radio" name="sex" value="F" checked="checked"> Female<br>
			<%
				}
			%>
			<b>Identity:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the identity" placeholder="EX: IF 456123"
				onfocusout="this.placeholder='EX: IF 456123'"
				onfocus="this.placeholder=''" type="text" name="id"
				value="<%=customerDetails.getLegalId()%>"><br> <b>Identity
				Type: </b><input title="Insert the identity type" placeholder="EX: CI"
				onfocusout="this.placeholder='EX: CI'" onfocus="this.placeholder=''"
				type="text" name="idType"
				value="<%=customerDetails.getLegalIdType()%>"><br> <b>Birthday:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the birthday" type="date" name="bday"
				value="<%=customerDetails.getBirthday()%>"><br> <b>Address</b><br>
			<div class="autocomplete">
				<input type="hidden" name="addr_id"
					value="<%=customerDetails.getAddress().getId()%>"> <b>Country:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
					style="width: 200px;" id="countriesList" title="Insert the country"
					placeholder="EX: Romania"
					onfocusout="this.placeholder='EX: Romania'"
					onfocus="this.placeholder=''" type="text" name="addr_country"
					value="<%=customerDetails.getAddress().getCountry()%>"
					required="required"
					oninvalid="this.setCustomValidity('Please enter valid country')"
					oninput="setCustomValidity('')"></input><br>
			</div>
			<br> <b>City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the city" placeholder="EX: Bucharest"
				onfocusout="this.placeholder='EX: Bucharest'"
				onfocus="this.placeholder=''" type="text" name="addr_city"
				value="<%=customerDetails.getAddress().getCity()%>"><br>
			<b>Street:
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the street" placeholder="EX: Nicolae Balcescu"
				onfocusout="this.placeholder='EX: Nicolae Balcescu'"
				onfocus="this.placeholder=''" type="text" name="addr_street"
				value="<%=customerDetails.getAddress().getStreet()%>"><br>
			<b>Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the number" placeholder="EX: 33bis"
				onfocusout="this.placeholder='EX: 33bis'"
				onfocus="this.placeholder=''" type="text" name="addr_nbr"
				value="<%=customerDetails.getAddress().getNumber()%>"><br>
			<b>Zip code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input
				title="Insert the zip code" placeholder="EX: 123456"
				onfocusout="this.placeholder='EX: 123456'"
				onfocus="this.placeholder=''" type="text" name="addr_cp"
		...
		<script>
			...
			var countries = [ "Afghanistan", "Albania", "Algeria", "Andorra",
					...
					"Romania", "Russia", "Rwanda", "Saint Pierre & Miquelon",
